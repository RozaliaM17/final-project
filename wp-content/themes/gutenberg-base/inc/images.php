 ...
 */
function dxgutenberg_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'dxgutenberg_post_thumbnail_sizes_attr', 10 , 3 );
 ...
 *
 * @since DX Gutenberg v1.1.0
 */
function dxgutenberg_featured_image( $size, $class = '', $attr = '' ) {
 ...
 * @since  DX Gutenberg v1.1.0
 */
function dxgutenberg_get_responsive_image() {
